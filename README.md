![header](https://capsule-render.vercel.app/api?type=waving&color=0:9be7ff,100:86a8e7&height=190&section=header&text=Subin's%20Github&fontSize=48&fontColor=5bc8fa&fontAlignY=40&animation=twinkling)
## 안녕하세요 전수빈입니다:)
<a href="https://cookusuniverse.tistory.com" target="blank">
...
`2025`
**kakao X groom 구름톤 유니브 4기 단국대학교(천안) 대표**
...
| **2025 DaVinci CTF** | **Aegis CTF Team** | **12위**|  |  |
| **2025 Hacksium in Busan 동남권 해킹방어대회** | **우리빼고다뚫림(팀장)** | **본선 진출** |  | 유관기업 입사로 인한 불참 |
...
`2025.01` **Toeic Speaking IM3**

`2025.01` **OPic IM1**

`2025.05` **우먼 IT's 3기 수료**

`2025.09` **KAKAO X 구름 주최 구름톤 유니브 4기 프론트엔드 & 대표 수료**
...
| Prowler NHN Cloud ISMS-P 감사 오픈소스 API 분석 문서 제작 |   |
| 머클트리를 이용한 SBOM 무결성 & 추적 가능성 검증 |   |
...
`2024.09` 
**Aegis Tech Talk : WebHacking**

`2025.03`
**Aegis Tech Talk : 자율주행자동차 내장 인공지능 소개**

`2025.04`
**대지중학교 코드클럽 : 코딩 봉사활동, 20시간**

`2025.05`
**Aegis Tech Talk : System Hacking - Fastbin Dump 기법 소개**

`2025.05`
**Aegis CTF 출제진 참여**

`2025.06`
**화이트해커 플랫폼 Dreamhack 커뮤니티 순위 184위 (상위 1% 이내)**
